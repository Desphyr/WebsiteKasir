...
<div class="container p-4 mx-auto">
    <h1 class="mb-6 text-3xl font-bold">Profil Saya</h1>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <h2 class="mb-4 text-xl font-semibold">Update Profil</h2>
            @if ($errors->any())
            ...
            <form action="{{ route('admin.profil.update') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Email (Untuk Lupa Password)</label>
        ...
        <!-- Form Ganti Password -->
        <div class="p-6 bg-white rounded-lg shadow-md">
            <h2 class="mb-4 text-xl font-semibold">Ganti Password</h2>
